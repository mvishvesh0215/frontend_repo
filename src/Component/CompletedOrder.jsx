...
import { getCompletedOrders } from '../Services/AdminService';
...
export default function CompletedOrder() {
    ...
    return (
        ...
        >
            <h2 className="text-2xl font-bold text-center mb-4">Completed Orders</h2>
            {orders.length === 0 ? (
                <p className="text-center text-gray-500">No completed orders available.</p>
            ) : (
                        ...
                        >
                            ...
                            {expandedOrderId === order.id && (
                                <div className="mt-4 p-4 border-t bg-gray-50 rounded-md">
                                    ...
                                    <p><strong>Order Status:</strong> <span className="text-green-500 font-semibold">{order.orderStatus}</span></p>
                                </div>
                            )}
                        </motion.div>
                    ))}
